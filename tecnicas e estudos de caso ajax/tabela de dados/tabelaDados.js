...
//EditarLinha - prepara uma linha para edição
//ExcluirLinha - se o usuario confirmar a exclusao ativa a função
//NovoRegistro - cria  alinha na penultima posição da tabela 
//SalvaDados - grava em um array do js os dados atuais da linha em edição
//Cancelar - cancela a edição de linha
//CancelarInclusao - cancela a inclusao de um novo produto
//Atualizar - ativa o programa do servidor para realizar alterações dos dados de um produto
//Cadastrar - ativa o programa do servidor para realizar a inclusao de um produto
//ObtemDadosForm - coloca os dados do formulario em formato de query string
//Aviso - exibe a mensagem com um fundo amarelo
//trataDados - recebe a resposta do servidor e realiza o tratamento de dados adequados