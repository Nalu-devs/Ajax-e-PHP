...
{
	$partes = explode("-",$_GET["quantidade"]);	// codigo e quant. estao separados por -
	$idProd = $partes[0];
	$novaQuant = $partes[1];
...
if($valorFrete>0) 
	...
	echo "N/D"; // frete nao disponivel para o local/peso atual
echo "</span></td>";
echo "</tr>";
...
echo "<p align=\"center\"><a href=\"javascript:Loja('limpar',0);\"></a> ";
echo "&nbsp;&nbsp;&nbsp;<a href=\"javascript:Loja('validaUsuario',0);\"></a></p>";
?>